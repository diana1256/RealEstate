...
import real.erstate.realestateagency_1.ui.fragment.home.HomeFragment.Companion.ID_PAR
...
class RealEstateFragment : Fragment() {
    ...
    private fun onViewModel() {
        ...
        if (arguments != null) {
            model = arguments?.getSerializable(ID_PAR) as Model
                    ...
                    Status.SUCCESS -> {
                        ...
                        adapterViewPager?.setOnItemClickListener(object :
                            ...
                            override fun onItemClick(image: ApartmentImage) {
                                ...
                                findNavController().navigate(R.id.photoFragment, bundleOf(ID_APART to mi))
                            }
                        })
